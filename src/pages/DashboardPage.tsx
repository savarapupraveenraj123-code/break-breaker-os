...
import type { BikeData, Fault } from '@/hooks/useBikeData';
...
interface DashboardPageProps {
  ...
  faults: Fault[];
  isRiding: boolean;
  dismissFault: (id: string) => void;
}

export default function DashboardPage({ data, faults, isRiding, dismissFault }: DashboardPageProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <CircularGauge value={data.engineTemp} max={140} label="Engine Temp" unit="°C" size={130} variant="temp" warningThreshold={95} criticalThreshold={110} />
            <CircularGauge value={data.fuelLevel} max={100} label="Fuel" unit="%" size={130} variant="fuel" warningThreshold={20} criticalThreshold={10} />
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="glass-card neon-border-blue p-4 mt-5">
            <h3 className="font-display text-xs tracking-wider uppercase text-muted-foreground mb-3">Ride Status</h3>
